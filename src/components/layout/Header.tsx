      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-xl font-bold text-primary cursor-pointer" onClick={() => navigate("/")}>AlmaConnect</h1>
          </div>
          ...
          <div className="flex items-center space-x-2">
            <Button 
              variant="ghost" 
              size="icon" 
              className={`relative ${location.pathname === '/messages' ? 'bg-primary/10 text-primary' : ''}`}
            ...
            <Button 
              variant="ghost" 
              size="icon" 
              className={`relative ${location.pathname === '/notifications' ? 'bg-primary/10 text-primary' : ''}`}
            ...
            <Button 
              variant="ghost" 
              size="icon"
              className={location.pathname === '/events' ? 'bg-primary/10 text-primary' : ''}
            ...
            <Button 
              variant="ghost" 
              size="icon"
              className={location.pathname === '/jobs' ? 'bg-primary/10 text-primary' : ''}
            ...
            <Button 
              variant="ghost" 
              size="icon"
              className={location.pathname === '/ai' ? 'bg-primary/10 text-primary' : ''}
              onClick={() => navigate('/ai')}
            >
