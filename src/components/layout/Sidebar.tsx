import { Home, Users, MessageCircle, Calendar, Briefcase, Bot, Clock, Settings, User, Bell, ChevronRight, X } from "lucide-react";
    ...
    <>
      ...
      `}>
        ...
        <div className="p-3 sm:p-4 space-y-4 sm:space-y-6">
          {/* User Profile Card */}
          <div>
            <Card className="professional-card cursor-pointer hover:alma-shadow-strong alma-transition" onClick={() => handleNavigation('/profile')}>
            ...
            {navigationItems.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  {item.count && (
                    <Badge variant="secondary" className="ml-2 text-xs hover:scale-110 transition-transform duration-200 flex-shrink-0">
                      {item.count}
                    </Badge>
                  )}
                </Button>
          ...
          <Card className="professional-card">
            <CardContent className="p-3 sm:p-4">
              <h4 className="font-semibold text-sm text-foreground mb-3 sm:mb-4">Recent Activity</h4>
