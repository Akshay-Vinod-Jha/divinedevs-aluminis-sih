...
const ChatBot = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      content:
        "Hello! I'm your AlmaConnect AI assistant. I can help you find alumni, explore career opportunities, or answer questions about our platform. What would you like to know?",
      sender: "ai",
      timestamp: new Date(),
    },
  ]);
  ...
  return (
    <>
      ...
      {isOpen && (
        <Card
          className={`fixed bottom-4 right-4 md:bottom-6 md:right-6 w-80 max-w-[calc(100vw-2rem)] alma-shadow-strong z-50 transition-all duration-300 ${
