import { User, Shield, Bell, Palette, Globe, Lock, Download, Trash2, Eye, EyeOff, Moon, Sun, Monitor, Volume2, VolumeX, Mail, Phone, MessageSquare, Camera, Edit3 } from "lucide-react";
...
const Settings = () => {
    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="h-48 bg-muted/40 rounded-lg animate-pulse"></div>
          ))}
        </div>
      </div>
    </div>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        <Sidebar />
        <main className={`flex-1 p-6 transition-all duration-300 ${isOpen ? 'max-w-4xl' : 'max-w-6xl'} mx-auto`}>
              ...
              <AnimatedCard>
                <div className={`hero-gradient rounded-xl p-8 mb-6 text-center alma-shadow-strong transition-all duration-1000 ${
                  ...
                  <p className="text-primary-foreground/90 text-lg">
                    Customize your AlmaConnect experience and manage your account preferences.
                  </p>
                </div>
              </AnimatedCard>
                          ...
                          <CardContent className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <div className="space-y-2">
                                ...
                                <Input id="email" type="email" placeholder="sarah.j@example.com" defaultValue="sarah.j@example.com" />
                              </div>
                              <div className="space-y-2">
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-2">
                                  ...
                                  <Input id="company" placeholder="Google" defaultValue="Google" />
                                </div>
                                <div className="space-y-2">
                              ...
                              <div className="space-y-2">
                                ...
                                <Select value={privacy.profileVisibility} onValueChange={(value) => handlePrivacyChange('profileVisibility', value)}>
                                  ...
                                  <SelectContent>
                                    ...
                                    <SelectItem value="alumni">Alumni Network Only</SelectItem>
                              ...
                              <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm">Searchable by search engines</span>
                                  </div>
                                  <Switch 
                              ...
                              <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                  <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">Get notified about relevant job opportunities</p>
                                  </div>
                                  <Switch 
                                ...
                                <div className="flex items-center justify-between">
                                  <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">Reminders for upcoming alumni events</p>
                                  </div>
                                  <Switch 
                                ...
                                <div className="flex items-center justify-between">
                                  <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">Updates from your professional network</p>
                                  </div>
                                  <Switch 
                                ...
                                <div className="flex items-center justify-between">
                                  <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">Updates about new features and services</p>
                                  </div>
                                  <Switch 
                            ...
                            <div className="space-y-4">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <Switch 
                                  ...
                                  onCheckedChange={(checked) => handleAppearanceChange('soundEnabled', checked)}
                                />
                              </div>
                            </div>
                              ...
                              <div className="space-y-4">
                                <div className="flex items-center justify-between">
                                  <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">Download a copy of your AlmaConnect data</p>
                                  </div>
                                  <Button variant="outline" size="sm">
                      ...
                      <CardContent className="space-y-4">
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm">
                            ...
                            <Badge variant="secondary">{privacy.profileVisibility}</Badge>
                          </div>
                          <div className="flex justify-between text-sm">
                          ...
                          <div className="flex justify-between text-sm">
                            ...
                            <Badge variant="secondary">
                              {Object.values(notifications).filter(Boolean).length}/8 enabled
                            </Badge>
                          </div>
                          <div className="flex justify-between text-sm">
                    ...
                    <Card className="professional-card">
                      ...
                      <CardContent className="space-y-3">
                        <p className="text-sm text-muted-foreground">
                          Need help with your settings? Our support team is here to assist you.
                        </p>
