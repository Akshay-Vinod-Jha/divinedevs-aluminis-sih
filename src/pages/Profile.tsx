import { User, MapPin, Briefcase, GraduationCap, Calendar, Mail, Phone, Globe, Edit, Settings, Award, TrendingUp, Users as UsersIcon, Eye, MessageCircle, Star, Building, Zap } from "lucide-react";
...
const Profile = () => {
  ...
  const experience = [
    ...
    },
    {
      ...
      description: "Developed and maintained React components for Instagram's web platform. Optimized performance resulting in 25% faster load times.",
    ...
    },
    {
      ...
      description: "Built full-stack web applications using MERN stack. Collaborated with designers to implement responsive user interfaces.",
  ...
  const education = [
    {
      ...
      duration: "2016 - 2020",
      grade: "CGPA: 8.7/10",
      achievements: ["Dean's List", "Best Final Year Project", "Coding Club President"]
    },
    {
      id: 2,
  ...
  const recentActivity = [
    ...
    },
    {
      id: 2,
      type: "connection",
      content: "Connected with 3 new alumni from the Computer Science department",
              ...
              <Card key={index} className="professional-card">
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="flex gap-2">
                    {[...Array(4)].map((_, i) => (
                      <div key={i} className="h-6 w-16 bg-muted/40 rounded-full animate-pulse"></div>
                    ))}
                  </div>
                </CardContent>
              </Card>
      ...
      <div className="flex justify-center items-center py-8">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col items-center">
            <div className="text-sm font-medium text-foreground mb-1">Loading profile</div>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap items-center gap-2 lg:gap-4 mt-2 text-xs lg:text-sm text-white/80">
                              ...
                              <span className="flex items-center gap-1">
                                ...
                                <span className="truncate">Class of {userProfile.batch}</span>
                              </span>
                            </div>
                          </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <Tabs defaultValue="experience" className="space-y-6">
                            ...
                            <CardContent className="p-6">
                              <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                  ...
                                  <p className="text-sm text-muted-foreground">{edu.field} • {edu.duration}</p>
                            ...
                            <CardContent className="p-6">
                              <div className="flex items-start gap-4">
                                <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                                  activity.type === 'post' ? 'bg-primary/10' :
                                  activity.type === 'connection' ? 'bg-accent/10' : 'bg-success/10'
                                }`}>
                                  {activity.type === 'post' && <TrendingUp className="h-5 w-5 text-primary" />}
                                  {activity.type === 'connection' && <UsersIcon className="h-5 w-5 text-accent" />}
                    ...
                    <TabsContent value="achievements" className="space-y-4">
                      <div className="flex items-center justify-between">
                        <h3 className="text-lg font-semibold text-foreground">Certifications & Awards</h3>
                        <Button variant="outline" size="sm">
                          <Edit className="h-4 w-4 mr-2" />
                          Add Certificate
                        </Button>
                      ...
                      <div className="space-y-4">
                        {achievements.map((achievement) => (
                          <Card key={achievement.id} className="professional-card">
                            <CardContent className="p-6">
                              <div className="flex items-start gap-4">
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="text-center">
                          <div className="text-2xl font-bold text-foreground">{profileViewsCount}</div>
                        ...
                        <div className="text-center">
                          <div className="text-2xl font-bold text-foreground">{connectionsCount}</div>
                          <div className="text-xs text-muted-foreground flex items-center justify-center gap-1">
                    ...
                    <CardContent className="space-y-4">
                      {skills.map((skill, index) => (
                        <div key={skill.name} className="space-y-2">
                          ...
                          <Progress value={skillProgressValues[index]} className="h-2" />
                        </div>
                      ))}
